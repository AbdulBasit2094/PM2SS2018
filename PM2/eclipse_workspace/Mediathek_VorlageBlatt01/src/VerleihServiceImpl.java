        ...
        VerleihService
{
    ...
    public void nimmZurueck(List<Medium> medien, Datum rueckgabeDatum)
    {
        ...
        //assert sindAlleNichtVerliehen(medien) : "Nachbedingung verletzt: sindAlleNichtVerliehen(medien)";
    }
    /**
    ...
    {
    	assert medienImBestand(medien): "Vorbedingung ist verletzt: medienImBestand(medien)";
